...
Ua[8]=function(a){if(null==a)return" null ";switch(typeof a){case "boolean":case "number":return" "+a+" ";default:return"'"+String(String(a)).replace(bb,db)+"'"}};var jb=/['()]/g,kb=function(a){return"%"+a.charCodeAt(0).toString(16)};Ua[12]=function(a){var b=
...
/^(?:(?:https?|mailto):|[^&:\/?#]*(?:[\/?#]|$))/i;Ua[14]=function(a){var b=String(a);return pb.test(b)?b.replace(lb,ob):"#zSoyz"};Ua[16]=function(a){return a};var qb;
...
return null},Xc=!1;if(F.querySelectorAll)try{var Yc=F.querySelectorAll(":root");Yc&&1==Yc.length&&Yc[0]==F.documentElement&&(Xc=!0)}catch(a){}var Uc=Xc;var ld={},md=null,od=Math.random();ld.s="GTM-PNMXCLV";ld.Ob="6a0";ld.Ld="";var pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},qd="www.googletagmanager.com/gtm.js";
var rd=qd,sd=null,td=null,ud=null,vd="//www.googletagmanager.com/a?id="+ld.s+"&cv=48",wd={},xd={},yd=function(){var a=md.sequence||0;md.sequence=a+1;return a};
...
(y("require","ec","ec.js"),B());var N={hitType:"event",eventCategory:String(e.vtp_eventCategory||f.category),eventAction:String(e.vtp_eventAction||f.action),eventLabel:x(String,e.vtp_eventLabel||f.label),eventValue:x(Aa,e.vtp_eventValue||f.value)};z(M,N,!1);y("send",N);}else if("TRACK_SOCIAL"==e.vtp_trackType){}else if("TRACK_TRANSACTION"==e.vtp_trackType){y("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var Y=function(O){return Q("transaction"+O,1)},ta=Y("Id");y("ecommerce:addTransaction",{id:ta,affiliation:Y("Affiliation"),revenue:Y("Total"),
shipping:Y("Shipping"),tax:Y("Tax")});for(var T=Y("Products")||[],L=0;L<T.length;L++){var J=T[L];y("ecommerce:addItem",{id:ta,sku:J.sku,name:J.name,category:J.category,price:J.price,quantity:J.quantity})}y("ecommerce:send");}else if("TRACK_TIMING"==e.vtp_trackType){}else if("DECORATE_LINK"==e.vtp_trackType){}else if("DECORATE_FORM"==e.vtp_trackType){}else if("TRACK_DATA"==e.vtp_trackType){}else{e.vtp_enableEcommerce&&(y("require","ec","ec.js"),B());if(e.vtp_doubleClick||"DISPLAY_FEATURES"==e.vtp_advertisingFeaturesType){var U="_dc_gtm_"+String(e.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");y("require","displayfeatures",void 0,{cookieName:U})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==e.vtp_advertisingFeaturesType){var ra="_dc_gtm_"+String(e.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,
...
f=h;Lk(m)}}}(function(f){W.__hl=f;W.__hl.b="hl";W.__hl.g=!0;W.__hl.priorityOverride=0})(function(f){var h=R("self");if(!Pk("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);Qk("hl")}G(f.vtp_gtmOnSuccess)})}();W.a.smm=["google"],function(){(function(a){W.__smm=a;W.__smm.b="smm";W.__smm.g=!0;W.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=zl(a.vtp_map,"key","value")||{};return c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue})}();
