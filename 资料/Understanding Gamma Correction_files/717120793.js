...
awf_Form_.showForm = function() {
    ...
    if (deprecatedBrowser) {
       window.open('https://forms.aweber.com/form/93/717120793.html','winPopUp','resizable=1,scrollbars=1,location=0,width=490,height=339');
